...
console.log(letsDance.substring(11) + letsDance.substr(1, 10) + letsDance.substring(0, 1));

// 9. Create 3 different variables about yourself, using strings as values, 
...
let city = "Hamburg";
let job = "editor";
console.log(`My name is ${firstName}. I live in ${city} and I am an ${job}.`);

// 10. Declare a variable and assign the value 
//"the quick brown fox" (all in lower case). 
//Capitalize the first letter of that string. Print the result to the console.
let lastTask =  "the quick brown fox";
let capitalize = lastTask.substr(0, 1).toUpperCase();
console.log(capitalize + lastTask.substring(1, 1);
